...
class HierSTModel(nn.Module):
    def __init__(self, config):
        ...
        self.clblock = CLBlock(config)
        self.advblock = adv(config)
    ...
    def forward(self, input_day, g):
        ...
        cl_loss = self.clblock(gcn_out)
        ad_loss = self.advblock(gcn_out)


        return self.y_t, cl_loss, ad_loss